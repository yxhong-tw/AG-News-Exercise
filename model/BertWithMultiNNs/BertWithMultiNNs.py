...
from model.BertWithMultiNNs.MultiClassifiers import MultiClassifier


class BertWithMultiNNs(nn.Module):
    def __init__(self, configs, device):
        super().__init__()

        self.lm = Bert()
        self.classifier = MultiClassifier(configs=configs, device=device)
